...
namespace Devices.Services.Migrations
{
    /// <inheritdoc />
    public partial class Migrations : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateIndex(
                name: "UQ__DeviceTy__737584F6D24D0306",
                table: "DeviceType",
                column: "Name",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "UQ__Person__45809E71645B4D49",
                table: "Person",
                column: "PassportNumber",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "UQ__Person__85FB4E380604C694",
                table: "Person",
                column: "PhoneNumber",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "UQ__Person__A9D1053498441C34",
                table: "Person",
                column: "Email",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "UQ__Position__737584F676A4DBCC",
                table: "Position",
                column: "Name",
                unique: true);
        }
